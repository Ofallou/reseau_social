...
var ChatWindowComponent = /** @class */ (function () {
    function ChatWindowComponent(authService, chatService, router) {
        var _this = this;
        this.authService = authService;
    ...
    ChatWindowComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"], _chat_chat_service__WEBPACK_IMPORTED_MODULE_2__["ChatService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]])
    ], ChatWindowComponent);
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(authService, commentService) {
        var _this = this;
        this.authService = authService;
        this.commentService = commentService;
        this.isMember = false;
    ...
    MemberSpaceComponent.prototype.ngOnInit = function () {
        ...
        this.activatedRouter.paramMap.subscribe(function (params) {
            ...
            _this.authService.getAllMembers()
                ...
                console.log(_this.membersNotFriends[1]);
                ...
                _this.authService.memberSpace(_this.member_pseudo).subscribe(function (res) {
                    ...
                    _this.user.friendsList.forEach(function (element) {
                        ...
                        _this.membersNotFriends.splice(_this.membersNotFriends.findIndex(function (user) { return user._id === element.friendId; }), 0);
                    });
                });
            });
