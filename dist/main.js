...
var CommentService = /** @class */ (function () {
    function CommentService(http, _router) {
        this.http = http;
        this._router = _router;
        this._postCommentUrl = 'http://localhost:5000/api/post_comment';
        this._getUserCommentsUrl = 'http://localhost:5000/api/comments';
...
var MemberActionService = /** @class */ (function () {
    function MemberActionService(http) {
        this.http = http;
        this._findMember = 'http://localhost:3000/api/member';
